...
export const ReportGenerator: React.FC = () => {
  ...
  const {
    ...
    handleSectionPhotoUpload, removeSectionPhoto, reorderSectionPhotos,
  ...
  const editSectionProps = {
    ...
    addExpense, updateExpense, removeExpense,
    handlePhotoUpload, handleGoalPhotoUpload, removeGoalPhoto, reorderGoalPhotos: state.reorderGoalPhotos, handleExpenseImageUpload,
    handleDocumentUpload,
    handleSectionPhotoUpload, removeSectionPhoto,
    reorderSectionPhotos: state.reorderSectionPhotos,
    handleSectionDocUpload, removeSectionDoc,
    insertDiaryPhotos,
    getActivitiesByGoal, getCommunicationActivities, getOtherActivities, formatActivityDate,
  };
