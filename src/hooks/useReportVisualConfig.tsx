...
const DEFAULT_CONFIG: ReportVisualConfig = {
  ...
  logoConfig: { visible: true, widthMm: 30 },
  logoCenterConfig: { visible: true, widthMm: 30 },
  logoSecondaryConfig: { visible: true, widthMm: 30 },
  ...
  footerLine1Text: 'Centro de Articulação de Populações Marginalizadas - CEAP',
  footerLine1FontSize: 9,
  footerLine2Text: 'R. Sr. dos Passos, 174 - Sl 701 - Centro, Rio de Janeiro - RJ, 20061-011',
  footerLine2FontSize: 7,
  footerLine3Text: 'ceapoficial.org.br | falecom@ceapoficial.org.br | (21) 9 7286-4717',
